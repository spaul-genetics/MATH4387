...
* Report (65 points):  
    ...
    - 40 pts:  Methods/Results.  Summary of data, appropriate methods used, appropriate graphical displays, proper diagnostic is performed, variable selection is discussed, interpretation of results are correct, etc.
